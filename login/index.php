...
<body>
	...
	<div id="registrar">
          	<a href="./php/registro.php"</a>registro del plantel</a>
    </div> <!-- fin opcion-->
		...
		<div id="contenedor">
			...
			<div id="cuerpo">
				<form id="form-login" action="./php/login.php" method="post" autocomplete="off">
					...
					<p><label > Usuario de la preparatoria:</label></p>
					...
					<p><label>contraseña el Tule</label></p>
			...
			<div id="pie">Datos de 5semestre</div>
		</div><!-- fin contenedor -->
