...
<body>
	...
	<div id="registrar">
          	<a href="./php/registro.php"</a>registro espiritu</a>
    </div> <!-- fin opcion-->
	...
	<div id="envoltura">
		<div id="contenedor">
			...
			<div id="pie">sitemas de informacion del 536</div>
		</div><!-- fin contenedor -->
